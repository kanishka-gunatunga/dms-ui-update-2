...
export default function AllDocTable() {
            ...
            <DashboardLayout>
                ...
                <div className="companyProfileTabs mt-4">
                    <Tabs
                        ...
                        onSelect={(k) => setActiveTab(k || "local")}
                            ...
                            <div className="d-flex flex-column bg-white p-2 p-lg-3 rounded mt-3">
                                ...
                                >
                                    <div className="d-flex flex-column">
                                        <div
                                            className="row row-cols-1 row-cols-lg-2 d-flex justify-content-around px-lg-3 mb-lg-3">
                                            <div
                                                className="col d-flex flex-column justify-content-center align-items-center p-0 px-3 px-lg-0 mb-4">
                                                <div className="d-flex flex-column w-100">
                                                    ...
                                                    {errorsLocal.document && (
                                                        <div style={{
                                                            color: "red",
                                                            fontSize: "12px"
                                                        }}>{errorsLocal.document}</div>
                                                    )}

                                                </div>
                                            </div>
                                            <div
                                                className="col d-flex flex-column justify-content-center align-items-center p-0 px-3 px-lg-0 ps-lg-2 mb-4">
                                                <p
                                                ...
                                                {errorsLocal.category && <div style={{
                                                    color: "red",
                                                    fontSize: "12px"
                                                }}>{errorsLocal.category}</div>}
                                                <div className="d-flex justify-content-start w-100">
                                                    {templateUrlLocal && (
                                                        <a href={templateUrlLocal} download style={{color: "#333"}}
                                                           className="d-flex flex-row mt-2 align-items-center ms-0">
                                                            <div
                                                                className="d-flex flex-row align-items-center custom-icon-button button-success px-3 py-1 rounded">
                                                                <IoMdCloudDownload/>
                                            ...
                                            <div
                                                ...
                                                {errorsLocal.sector_category && <div style={{
                                                    color: "red",
                                                    fontSize: "12px"
                                                }}>{errorsLocal.sector_category}</div>}
                                            </div>
                                            <div
                                                className="col d-flex flex-column justify-content-center align-items-center p-0 px-3 px-lg-0 ps-lg-2 mb-4">
                                                <div className="d-flex flex-column w-100">
                                                ...
                                                {errorsLocal.document && <div style={{
                                                    color: "red",
                                                    fontSize: "12px"
                                                }}>{errorsLocal.document}</div>}
                                            </div>
                                            <div
                                                className="col d-flex flex-column justify-content-center align-items-start p-0 px-3 px-lg-0 mb-4">
                                            ...
                                            <div
                                                className="col d-flex flex-column justify-content-center align-items-center p-0 px-3 px-lg-0 mb-2"></div>
                                                ...
                                                <div className="d-flex flex-column mt-3">
                                                    {uploadProgress.map((fileProgress, index) => (
                                                        <div key={index} className="d-flex flex-row mb-3"
                                                             style={{width: '100%'}}>
                                                            <p className="mb-0"
                                                               style={{fontSize: "14px"}}>{fileProgress.fileName}</p>
                                                            <p
                                                                className="ms-5 mb-0"
                                                                style={{
                                                                    fontSize: "14px",
    ...
    Failed to process documents. Please try again.
                                ...
                                >
                                    <div className="d-flex flex-column">
                                        <div
                                            className="row row-cols-1 row-cols-lg-2 d-flex justify-content-around px-lg-3 mb-lg-3">
                                            <div
                                                className="col justify-content-center align-items-center p-0 px-3 px-lg-0 mb-4">
                                                <div className="d-flex flex-column w-100">
                                                    <p className="mb-1 text-start w-100" style={{fontSize: "14px"}}>
                                                ...
                                                {errors.document && <div
                                                    style={{color: "red", fontSize: "12px"}}>{errors.document}</div>}
                                            </div>
                                            <div
                                                className="col d-flex flex-column justify-content-center align-items-center p-0 px-3 px-lg-0 ps-lg-2 mb-4">
                                                <p
                                                ...
                                                {errors.category && <div
                                                    style={{color: "red", fontSize: "12px"}}>{errors.category}</div>}
                                                <div className="d-flex justify-content-start w-100">
                                                    {templateUrl && (
                                                        <a href={templateUrl} download style={{color: "#333"}}
                                                           className="d-flex flex-row mt-2 align-items-center ms-0">
                                                            <div
                                                                className="d-flex flex-row align-items-center custom-icon-button button-success px-3 py-1 rounded">
                                                                <IoMdCloudDownload/>
                                            ...
                                            <div
                                                ...
                                                {errors.sector_category && <div style={{
                                                    color: "red",
                                                    fontSize: "12px"
                                                }}>{errors.sector_category}</div>}
                                            </div>
                                            <div
                                                className="col d-flex flex-column justify-content-center align-items-center p-0 px-3 px-lg-0 ps-lg-2 mb-4">
              ...
              Please wait until we process your documents{" "}
                ...
                <div
                    className="fixed-bottom bg-white border-top shadow-lg d-flex align-items-center justify-content-end px-4"
                    style={{
                        height: "70px",
                        zIndex: 1000,
                        // Adjust '260px' to match your Sidebar width.
                        // If sidebar collapses, you might need dynamic width logic or just use width: "100%" if it overlays sidebar.
                        left: "260px",
                ...
                >
                    ...
                    <Link
                        href="/bulk-upload/add"
                        className="custom-icon-button button-danger px-4 py-2 rounded text-decoration-none d-flex align-items-center me-3"
                        onClick={(e) => {
                            e.preventDefault();
                            window.location.reload();
                        }}
                    >
                        <MdOutlineCancel fontSize={18} className="me-2" /> Cancel
                    </Link>

                    <button
                        disabled={loading || (activeTab === 'local' ? (!apiCallLocalFailed && localSubmitted) : (!apiCallExcelFailed && localSubmitted))}
                        onClick={(e) => activeTab === 'local' ? handleExcelFileSubmitLocal(e as unknown as React.FormEvent) : handleExcelFileSubmit(e as unknown as React.FormEvent)}
                        className="custom-icon-button button-success px-4 py-2 rounded"
                    >
                        {loading ? (
                            "Submitting..."
                        ) : (
                            <>
                                <IoSaveOutline fontSize={18} className="me-2" /> Save
                            </>
                        )}
                    </button>
                </div>
