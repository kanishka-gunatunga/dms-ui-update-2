            ...
            <DashboardLayout>
                <div style={{paddingBottom: "800px"}}>
                    ...
                    <div className="d-flex flex-column bg-white p-2 p-lg-3 rounded-4 mt-3">
                        ...
                        <div className="d-flex flex-column  custom-scroll"
                ...
                >
                    <button
                        disabled={(formSubmitted)}
                        onClick={() => handleAddRolePermission()}
                        className="custom-icon-button button-success px-3 py-2 rounded me-3"
                    >
                        <IoSave fontSize={18} className="me-2"/> Yes
                    </button>
                    <Link
                        href={"/roles"}
                        className="custom-icon-button button-danger px-3 py-2 rounded d-flex align-items-center text-decoration-none"
                    >
                        <MdOutlineCancel fontSize={18} className="me-2"/> No
                    </Link>
                </div>
            </DashboardLayout>
            <ToastMessage
