                                            ...
                                            <td className="d-flex flex-row border-0">
                                                {hasPermission(permissions, "Role", "Edit Role") && (
                                                    <Link href={`/roles/${item.id}`}
                                                          className="custom-icon-button button-success px-2 py-1 rounded me-2">
                                                ...
                                                {hasPermission(permissions, "Role", "Delete Role") && (
                                                    <button
                                                        onClick={() => handleOpenModal("deleteRoleModel", item.id, item.role_name)}
                                                        className="custom-icon-button button-danger px-2 py-1 rounded">
