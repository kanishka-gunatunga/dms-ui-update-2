    ...
    return (
        <>
            ...
            /> */}
                ...
                >
                    <button
                        onClick={activeTab === 'general' ? handleCancel : handleStorageCancel}
                        className="custom-icon-button button-danger px-4 py-2 rounded d-flex align-items-center me-3"
                    >
                        <MdOutlineCancel fontSize={18} className="me-2" /> Cancel
                    </button>

                    <button
                        onClick={activeTab === 'general' ? handleSave : handleStorageSave}
